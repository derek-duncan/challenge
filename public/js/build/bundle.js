...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateBrowserHistory = __webpack_require__(201);

	var _historyLibCreateBrowserHistory2 = _interopRequireDefault(_historyLibCreateBrowserHistory);

	var _routesClient = __webpack_require__(215);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAppJsx = __webpack_require__(216);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsAppActions = __webpack_require__(217);
	...
	var _componentsHeaderJsx = __webpack_require__(232);
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      _storesAppStore2['default'].listen(this.handleChange.bind(this));
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      _storesAppStore2['default'].unlisten(this.handleChange);
	    }
	  }, {
	    key: 'handleChange',
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { id: 'app' },
	        _react2['default'].createElement(_componentsHeaderJsx2['default'], { pageTitle: this.state.pageTitle }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alt = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStateFunctions = __webpack_require__(223);

	var StateFunctions = _interopRequireWildcard(_utilsStateFunctions);

	var _utilsFunctions = __webpack_require__(224);
	...
	var _utilsAltUtils = __webpack_require__(226);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltStore = __webpack_require__(227);

	var _AltStore2 = _interopRequireDefault(_AltStore);

	var _StoreMixin = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transmitter = __webpack_require__(228);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppStore = (function () {
	  ...
	  _createClass(AppStore, [{
	    key: 'onSetPageTitle',
	    value: function onSetPageTitle(title) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeaderTitle = (function (_React$Component) {
	  ...
	  function HeaderTitle() {
	    ...
	    _get(Object.getPrototypeOf(HeaderTitle.prototype), 'constructor', this).apply(this, arguments);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Challenge = (function (_React$Component) {
	  ...
	  function Challenge(props) {
	    ...
	    this.state = Object.assign({}, _storesChallengeStore2['default'].getState(), {
	  ...
	  _createClass(Challenge, [{
	    ...
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      _storesChallengeStore2['default'].unlisten(this.onChange);
	    }
	  }, {
	    key: 'handleURLFocus',
	    value: function handleURLFocus(e) {
	      e.preventDefault();
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement('input', { className: 'challenge-url', type: 'text', ref: 'url', value: this.state.url, onClick: this.handleURLFocus })
	        ),
	        _react2['default'].createElement(
	          _CarderJsx2['default'],
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _alt2['default'].createStore(ChallengeStore, 'ChallengeStore');
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChallengeActions = function ChallengeActions() {
	  _classCallCheck(this, ChallengeActions);

	  this.generateActions('setName');
	};
	...
	var ChallengeName = (function (_React$Component) {
	  ...
	  _createClass(ChallengeName, [{
	    ...
	    value: function handleChange(e) {
	      ...
	      _actionsChallengeActions2['default'].setName(value);
	    }
	  }, {
	    key: 'handleKeyDown',
	...
	var Carder = (function (_React$Component) {
	  ...
	  _createClass(Carder, [{
	    ...
	    value: function handleSwipe(e) {
	      if (e.direction === 4) {
	        // right
	        _actionsCarderActions2['default'].previousCard();
	      } else if (e.direction === 2) {
	        // left
	        _actionsCarderActions2['default'].nextCard();
	      }
	    }
	  }, {
	    key: 'render',
